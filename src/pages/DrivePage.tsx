...
export const DrivePage: React.FC = () => {
  // Using a demo user ID - in production, this should come from auth context
  ...
  const usedSpacePercent = Math.min((totalSize / (10 * 1024 * 1024 * 1024)) * 100, 100); // 10GB limit
    ...
    <div className="min-h-screen bg-black pt-24 pb-12 px-4 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Store and manage your personal files in one secure place (Private - only you can access)</p>
        </div>
          ...
          <div className="w-full bg-gray-700 rounded-full h-2">
            <div
              className={`h-2 rounded-full transition-all duration-300 ${
                usedSpacePercent > 90 ? 'bg-red-600' : usedSpacePercent > 70 ? 'bg-orange-600' : 'bg-yellow-600'
              }`}
        ...
        <div className="mt-8 p-4 bg-blue-600/10 border border-blue-600/30 rounded-lg">
          ...
          <p className="text-sm text-gray-300">
            ✓ All your files are encrypted and securely stored in the cloud<br />
            ✓ Only you can access your files - completely private<br />
            ✓ Perfect for storing personal assignments, notes, and projects<br />
            ✓ Maximum file size: 100MB per file | Total storage: 10GB<br />
            ✓ Want to share materials? Use the Study Materials section instead!
          </p>
        </div>
      </div>
    </div>
