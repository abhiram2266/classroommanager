      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="px-3 py-1 bg-green-600/20 border border-green-600/40 rounded text-sm text-green-400">🌍 Shared</span>
          </div>
          <p className="text-gray-400">Access study resources shared by the community</p>
        </div>
        ...
        <div className="mb-8">
          <button
            ...
            className="px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-black font-semibold rounded"
          >
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 bg-green-600/10 border border-green-600/30 rounded-lg">
            <p className="text-sm text-green-600 font-semibold mb-2">🌍 Community Shared</p>
            <p className="text-sm text-gray-300">Materials visible to everyone</p>
          </div>
          <div className="p-4 bg-yellow-600/10 border border-yellow-600/30 rounded-lg">
            ...
            <p className="text-sm text-gray-300">PYQs, notes, books, and manuals</p>
          </div>
          <div className="p-4 bg-blue-600/10 border border-blue-600/30 rounded-lg">
            <p className="text-sm text-blue-600 font-semibold mb-2">🤝 Contribute</p>
            <p className="text-sm text-gray-300">Share materials to help students</p>
          </div>
        </div>
      </div>
    </div>
